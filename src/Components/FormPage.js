...
function FormPage(){
    ...
    return(
        <>
            ...
            <Button className="centered" name="outpost" onClick={handleFormAppear}>Outpost Form</Button>
            <Button className="centered" name="leisure" onClick={handleFormAppear}>Leisure Form</Button>
